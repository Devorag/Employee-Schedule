...
union select (select c.cuisineId from Cuisine c where c.CuisineType = 'English'), u.usersId, 'Lamb chops', 350, '11-10-2017', '01-01-2018', '02-02-2019' from users u where u.lastname = 'Weinberger'
union select (select c.CuisineId from cuisine c where c.CuisineType = 'American'), u.usersId, 'Sweet roll', 375, '01-01-2016', null , null from users u where u.LastName = 'Svei'
