...
Trip table should include a destination, start date, end date, miles traveled, and foreign key to car.
Omit constraints 
Populate tables with enough rows of data to make CRUD interesting. Include people without cars, and cars without trips
*/
--SELECT
